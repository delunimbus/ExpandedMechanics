local InvaderMagicBullet, super = Class(Bullet, "virovirokun/invader_bullet")

function InvaderMagicBullet:init(x, y, buffed)
    super.init(self, x, y)
...
function InvaderMagicBullet:update()
    self.sprite:setColor(0, 1, 1)
    super.update(self)
    print("wtf/???")

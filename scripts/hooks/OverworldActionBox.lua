...
function OverworldActionBox:draw()
    ...
    if self.chara:usesMana() then
        ...
        if mana > 0 then
            ...
            Draw.setColor(30/255, 144/255, 1--[[self.actbox.battler.chara:getXActColor()]])
        ...
        local outline_canvas = Draw.pushCanvas(SCREEN_WIDTH, SCREEN_WIDTH)
            ...
            Draw.getOutlineDraft(self.chara:getHealth(), 182 - health_offset - string_width_health, 9)
            Draw.getOutlineDraft("/", 192 - string_width_health, 9)
            Draw.getOutlineDraft(self.chara:getStat("health"), 207 - string_width_health, 9)

            Draw.getOutlineDraft(self.chara:getMana(), 182 - mana_offset - string_width_mana, 25)
            Draw.getOutlineDraft("/", 192 - string_width_mana, 25)
            Draw.getOutlineDraft(self.chara:getStat("mana"), 207 - string_width_mana, 25)

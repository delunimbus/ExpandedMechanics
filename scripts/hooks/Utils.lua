...
-------------------------------------------------------                     DO WE REALLY HAVE TO COPY ALL OF UTILS??? ok

--- Creates a value out of a fraction.
---@param value number          The value to make the fraction for
---@param numerator number      The numerator
---@param denominator number    The denominator
function Utils.getFractional(value, numerator, denominator)
    local result = value

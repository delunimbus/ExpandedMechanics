...
function character:init()
    ...
    ---------------------------------------------------
    self:setSpellResourceType("heal_prayer", "mana")
    self:setSpellResourceType("sleep_mist", "mana")
    self:setSpellResourceType("ice_shock", "mana")
    ----------------------------------------------------
...
function character:getTitle()
    ...
    elseif Game.chapter == 4 then
        return prefix.."Cryomancer\nMember of House\nHoliday-Snowwhite."    --Lore for my theoretical FF7xUTDT fanfic
    else
